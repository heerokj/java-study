package day12hw; //Q05.4번문제에서 키보드 화살표 asdw를 누르면 상하좌우로 움직일수 있는 기능을 추가
...
public class TestMain05 extends Frame implements KeyListener{
	...
	public void keyPressed(KeyEvent e) {
		...
		if(code == 65) { //키보드 눌렀을때의 값이 65(a)일경우 모든x값(x1~x6)이 마이너스! => 그것을 대입
			x1 -= 3;
			x2 -= 3;
			x3 -= 3;
			x4 -= 3;
